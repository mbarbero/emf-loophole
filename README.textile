h1. EMF Loophole - Generation Gap Pattern tooling
...
EMF Loophole is supporting all EMF versions since 2.5. Add one of the following p2 repository (update-site) in your update manager (in Eclipse, @Help Menu > Install New Software...@, @Add...@ button on the top right corner):
...
or add the following composite update site referencing all of these versions:

h3. *http://mbarbero.github.io/emf-loophole/*

Then, select the "EMF Loophole" feature and click on @Finish@.
