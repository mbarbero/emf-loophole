...
import org.eclipselabs.emf.loophole.internal.model.provider.GenGapModelItemProvider;

/**
 * @author <a href="mailto:mikael.barbero@obeo.fr">Mikael Barbero</a>
 * 
 */
public class GenGapModelItemProviderCustomImpl extends GenGapModelItemProvider
	 ...
	 */
	public GenGapModelItemProviderCustomImpl(ComposeableAdapterFactory adapterFactory) {
	...
	public void setTarget(Notifier target) {
		...
		if (target == null) {
			...
			GenGapModel genGapModel = (GenGapModel) target;
			delegateItemProvider = (IChangeNotifier) ((ComposeableAdapterFactory) adapterFactory)
					.getRootAdapterFactory().adapt(genGapModel.getGenModel(),
	...
	/**
	 * This returns the parent of the GenGapModel.
	 */
	@Override
	...
	public Object getImage(Object object) {
		GenGapModel GenGapModel = ((GenGapModel) object);
		Object image = itemDelegator.getImage(GenGapModel.getGenModel());
	...
	public String getText(Object object) {
		GenGapModel GenGapModel = ((GenGapModel) object);
		return itemDelegator.getText(GenGapModel.getGenModel());
	}
